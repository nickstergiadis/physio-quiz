const CATEGORY_CONFIG = {
  shoulder: {
    ...
    topics: [
      ...
      {
        title: 'posterior shoulder instability in contact athlete',
        hallmark: 'posterior shoulder pain and apprehension during flexion-adduction-internal rotation after contact trauma',
        initialManagement: 'stabilization-focused loading with scapular-cuff control and graded sport contact exposure',
        education: 'posterior instability often needs direction-specific control retraining, not just general strengthening',
        progression: 'improved tolerance to push, tackle, and horizontal loading tasks without apprehension',
        precaution: 'recurrent traumatic subluxation episodes with escalating instability frequency'
      },
      {
        title: 'suprascapular neuropathy in overhead athlete',
        hallmark: 'posterolateral shoulder fatigue with external rotation weakness and infraspinatus atrophy signs',
        initialManagement: 'reduce aggravating overhead volume, assess kinetic-chain contributors, and coordinate specialist evaluation',
        education: 'persistent focal weakness in overhead athletes can reflect neural involvement requiring timely reassessment',
        progression: 'external rotation endurance and overhead capacity improve with reduced neural irritability',
        precaution: 'progressive objective weakness or visible muscle wasting despite load modification'
      }
    ]
  },
  knee: {
    ...
    topics: [
      ...
      { title: 'patellar instability after lateral dislocation', hallmark: 'apprehension in early flexion with giving-way after traumatic lateral patellar displacement', initialManagement: 'early quadriceps-hip control training, swelling management, and staged return to dynamic tasks', education: 'recurrent instability risk can be reduced through targeted control and load progression', progression: 'single-leg landing and deceleration show improved frontal plane control without apprehension', precaution: 'osteochondral injury signs such as locked knee after dislocation' },
      { title: 'hip-related contribution to anterior knee pain', hallmark: 'anterior knee pain linked to dynamic valgus and weak hip abductor-external rotator control', initialManagement: 'combine hip-focused strengthening with knee task retraining and load calibration', education: 'proximal control deficits can drive persistent knee symptoms during functional tasks', progression: 'stair, squat, and running tolerance improve with better lower-limb alignment control', precaution: 'night pain or unexplained swelling inconsistent with load-related behavior' }
    ]
  },
  'low back': {
    slug: 'lowback',
    ...
    topics: [
      ...
      { title: 'lumbar spondylolisthesis with extension intolerance', hallmark: 'activity-related low back pain worsened by extension and improved with flexion-biased positions', initialManagement: 'relative extension deload, trunk-hip endurance training, and graded return to extension demands', education: 'symptom-guided loading can improve function even when imaging shows structural change', progression: 'standing and extension-tolerant tasks improve without escalating pain response', precaution: 'progressive neurologic deficit or severe unremitting night pain' },
      { title: 'inflammatory back pain referral pattern', hallmark: 'insidious back pain with morning stiffness over 30 minutes that improves with movement but not rest', initialManagement: 'screen inflammatory features and coordinate timely medical referral while maintaining gentle activity', education: 'persistent inflammatory symptom patterns need collaborative medical workup beyond routine MSK care', progression: 'post-referral management emphasizes mobility, conditioning, and self-management capacity', precaution: 'uveitis symptoms or other systemic inflammatory manifestations requiring urgent medical input' }
    ]
  },
  ankle: {
    slug: 'ankle',
    ...
    topics: [
      ...
      { title: 'insertional Achilles tendinopathy', hallmark: 'posterior heel pain at Achilles insertion aggravated by hill running and compressive dorsiflexion tasks', initialManagement: 'modify compression-provoking tasks and implement progressive calf loading within tolerance', education: 'insertional symptoms may need temporary range modification while load capacity is rebuilt', progression: 'heel-raise endurance and graded running tolerance improve with stable next-day response', precaution: 'sudden gap sensation with marked plantarflexion weakness suggesting rupture' },
      { title: 'common fibular nerve irritation after ankle trauma', hallmark: 'dorsum foot paresthesia and dorsiflexor weakness after inversion injury near fibular neck', initialManagement: 'urgent neurologic reassessment, protect from excessive nerve tension, and coordinate medical follow-up when deficits persist', education: 'new motor deficit after trauma needs close monitoring and may require referral', progression: 'sensory and dorsiflexion recovery supports graded gait and balance progression', precaution: 'progressive foot drop or expanding sensory loss' }
    ]
  },
  'cervical spine': {
    slug: 'cervical',
    ...
    topics: [
      ...
      { title: 'peripheral nerve entrapment versus cervical radicular mimic', hallmark: 'distal upper-limb paresthesia reproduced by local compression tests with minimal neck provocation', initialManagement: 'differentiate local nerve interface irritability from cervical drivers and dose nerve-loading accordingly', education: 'similar symptoms can arise from different sites, so exam clustering improves treatment precision', progression: 'functional tasks and neural loading are tolerated with reduced distal symptom reproduction', precaution: 'rapidly progressive motor weakness in a peripheral nerve distribution' },
      { title: 'cervical arterial dysfunction red-flag screen', hallmark: 'new severe neck pain with cranial nerve symptoms, diplopia, or drop attacks inconsistent with mechanical pattern', initialManagement: 'stop routine cervical loading and activate urgent medical referral pathway', education: 'vascular warning clusters require immediate escalation rather than musculoskeletal trial treatment', progression: 'rehabilitation decisions follow specialist clearance and diagnosis', precaution: 'this warning-pattern constellation is an urgent referral trigger' }
    ]
  },
  'exercise prescription': {
    ...
    topics: [
      ...
      { title: 'return-to-sport criteria integration', hallmark: 'athlete nearing discharge with mixed physical test results and confidence concerns', initialManagement: 'combine strength, power, movement-quality, and psychological readiness metrics to guide staged return', education: 'single tests alone are insufficient for high-stakes return-to-sport decisions', progression: 'objective criteria and sport-specific exposure are met without adverse symptom response', precaution: 'recurrent giving-way or major asymmetry despite progressed rehabilitation' },
      { title: 'plyometric reintroduction after lower-limb injury', hallmark: 'adequate baseline strength but limited tolerance to fast stretch-shortening cycle demands', initialManagement: 'start low-amplitude bilateral plyometrics and progress volume, intensity, and complexity systematically', education: 'impact progression should be criteria-led with monitoring of 24-hour symptom response', progression: 'single-leg reactive tasks are tolerated with controlled landing mechanics and stable symptoms', precaution: 'pain and swelling escalation persisting beyond expected recovery window' },
      { title: 'vestibular and balance exercise progression', hallmark: 'motion-provoked dizziness with reduced gaze stability and dynamic balance confidence', initialManagement: 'prescribe individualized gaze-stability, habituation, and balance tasks dosed to mild transient symptom provocation', education: 'brief symptom provocation can be therapeutic when recovery occurs promptly after practice', progression: 'reduced dizziness handicap and improved dynamic balance under dual-task conditions', precaution: 'new focal neurologic deficits, severe headache, or acute hearing loss' }
    ]
  }
};
